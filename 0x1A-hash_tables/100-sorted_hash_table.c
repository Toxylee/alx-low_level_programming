...
/**
 * screate_item - function creates items for the hashtable array
...
/**
 * shash_table_set - function adds an element to sorted hash table
...
/**
 * shash_table_print - prints the hash table from head node
 * @ht: pointer to the hash table
 *
 * Return: Nothing
 */
...
/**
 * shash_table_get - function retrieves a value associated
 * with a key
